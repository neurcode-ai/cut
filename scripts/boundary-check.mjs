...
for (const absolute of allFiles) {
  ...
  if (/^packages\/(?:format|compiler|cli|viewer|sdk)\/src\//.test(path)) {
...
for (const packagePath of ['packages/format', 'packages/compiler', 'packages/cli', 'packages/viewer', 'packages/sdk']) {
