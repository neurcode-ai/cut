...
The `0.2.x` format package reads archives from `0.1.x`. Additive optional fields
...
The legacy `@neurcode-ai/cli share` command remains supported for one normal
deprecation cycle after the focused CLI release.
